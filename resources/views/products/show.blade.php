      ...
      <div class="flex flex-col border-b border-black pb-4 px-6 md:px-0 md:flex-row md:pb-0 md:w-1/2 md:min-w-[500px] md:border-b-0 md:border-r ">
        ...
        <div class="flex flex-col justify-between gap-3 md:gap-6">
          ...
          <div class="flex flex-col gap-3">
            ...
            <a href="{{route('login')}}" @auth x-on:click.prevent="window.livewire.emit('addToCart', {{$book->id}}, quantity)" @endauth class="pl-6 py-1 rounded-xl bg-black text-white w-44">Dodaj u korpu <i class="fa-solid fa-cart-shopping"></i></a>
          </div>
          <!--End group -->
        </div>
      </div>
