        ...
        <span class="relative z-0 inline-flex ">
          <span>
            ...
            @if ($paginator->onFirstPage())
              <span class="relative inline-flex items-center px-2 py-2 text-gray-400" aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
          ...
          <span>
            ...
            @else
              <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                <span class="relative inline-flex items-center px-2 py-2 text-gray-400" aria-hidden="true">
                  <i class="fa-solid fa-angle-right"></i>
                </span>
              </span>
            @endif
